...
dependencies {
	...
	implementation("org.mapstruct:mapstruct:${mapStructureVersion}")
	...
	annotationProcessor("org.mapstruct:mapstruct-processor:${mapStructureVersion}")
